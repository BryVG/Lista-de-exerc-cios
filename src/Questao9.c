...
void removeVoo(Voo *voos, int *count, int numeroVoo) {
    int i, encontrado = 0;
    for (i = 0; i < *count; i++) {
        if (voos[i].numero == numeroVoo) {
            encontrado = 1;
...
int main() {
    ...
    do {
        ...
        printf("3. Remover voo pelo numero\n");
		printf("4. Sair\n");
        ...
        switch(opcao) {
            ...
            case 3:
                {
                    int numeroVoo;
                    printf("Digite o numero do voo que deseja remover: ");
                    scanf("%d", &numeroVoo);
                    removeVoo(voos, &count, numeroVoo);
                }
                break;
			case 4:
